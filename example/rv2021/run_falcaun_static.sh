#!/bin/bash -u
#****h* rv2021/run_falcaun_static.sh
# NAME
#  run_falcaun_static
# DESCRIPTION
#  Script to execute an experiment using FalCAuN with static STL. By default, the timeout is 240 min.
#
# USAGE
#  ./run_falcaun_static.sh [kind] [Spec]
#  ./run_falcaun_static.sh [kind] [Spec] [timeout in sec.]
#
# EXAMPLE
#  ./run_falcaun_static.sh GA AT_F1
#  ./run_falcaun_static.sh HC AT_F2
#  ./run_falcaun_static.sh GA AT_F2 $((240 * 60))
#******

if (($# < 2)); then
    echo 'Usage: ./run_falcaun_static.sh [kind] [Spec]'
    echo 'Usage: ./run_falcaun_static.sh [kind] [Spec] [timeout in sec.]'
    echo 'Example: ./run_falcaun_static.sh GA AT_F1'
    echo 'Example: ./run_falcaun_static.sh GA AT_F2'
    echo 'Example: ./run_falcaun_static.sh GA AT_F2 $((240 * 60))'
    exit
else
    kind=$1
    spec=$2
