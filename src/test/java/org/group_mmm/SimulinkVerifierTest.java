...
class SimulinkVerifierTest {
    ...
    private AdaptiveSTLUpdater propertyZHA19_AFC1 = new StaticLTLList(new ArrayList<>(Collections.singletonList("X [] (output == \"a00l\" || output == \"a01l\" || output == \"a01h\" || output == \"b00l\" || output == \"b01l\" || output == \"b01h\" || output == \"b00l\" || output == \"b01l\" || output == \"b01h\"|| output == \"c00l\" || output == \"c01l\" || output == \"c01h\")")));


    @BeforeEach
    void setUp() {
        // [] (velocity < 30)
        properties = new StaticLTLList(new ArrayList<>(Collections.singletonList("[] (output == \"a00\")")));
