...
public class MutateSelectEQOracle implements EquivalenceOracle.MealyEquivalenceOracle<String, String> {
    private static final Logger LOGGER = LoggerFactory.getLogger(MutateSelectEQOracle.class);
    Random random;
    int generationSize;
    int childrenSize;
    ...
    MutateSelectEQOracle(SimulinkMembershipOracleCost memOracle,
                         int length,
                         Random random,
                         int maxTests,
                         int generationSize,
